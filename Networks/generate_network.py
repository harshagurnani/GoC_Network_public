...
def create_GoC_network( duration, dt, seed, runid, run=False, girk=False):
	...
	MFSyn_filename = '../Mechanisms/MF_GoC_Syn.nml'						# small conductance synapse for background inputs
	...
	MF20Syn_filename = '../Mechanisms/MF_GoC_SynMult.nml'					# multi-syn conductance for strong/coincident transient input
